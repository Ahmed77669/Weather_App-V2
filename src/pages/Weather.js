            ...
            <div id="mains">
                <div id="cont">
                    ...
                    <div style={{display:"flex", justifyContent:"center"}}>
                        <p style={{fontFamily:'"Poppins", sans-serif', fontSize:"60px", marginTop:"0", marginBottom:"0px", color:"#fff", lineHeight:"60px"}}>
                            {Math.floor(data.celcius)}°c<br/>
                            <span style={{fontSize:"35px", fontWeight:"400"}}>{data.name}</span>
                        </p>
                    </div>
                    <div style={{display:"flex", justifyContent:"space-between"}}>
                        <div style={{display:"flex", marginLeft:"20px", marginTop:"40px"}}>
                            ...
                            <div style={{display:'flex', justifyContent:"top"}}>
                                <p style={{textAlign:"center", marginTop:"10%", color:"white", fontFamily:'"Poppins", sans-serif', lineHeight:"20px"}}>
                                    {data.humidity}%<br/><span>Humidity</span>
                                </p>
                            </div>
                        </div>
                        <div style={{display:"flex", marginRight:"20px", marginTop:"40px"}}>
                            ...
                            <div style={{display:'flex', justifyContent:"top"}}>
                                <p style={{textAlign:"center", marginTop:"8%", color:"white", fontFamily:"'Poppins', sans-serif"}}>
                                    {data.speed} Km/h<br/><span>Wind Speed</span>
                                </p>
                            </div>
                        </div>
                    </div>
